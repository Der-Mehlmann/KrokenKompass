...
// PROGRESS
                    ...
                    A2(
                        ...
                        _List_fromArray(
                            [
                                A2(
                                    ...
                                    _List_fromArray(
                                        [
                                            ...
                                            $elm$html$Html$Events$onClick(
                                                $author$project$Main$LinkClicked(
                                                    $elm$browser$Browser$External('javascript:window.toggleTheme()'))),
                                ...
                                function () {
                                    var fragment = A2($elm$core$Maybe$withDefault, '', model.url.fragment);
                                    var _v0 = (fragment === '') ? _Utils_Tuple2(
                                        'Raum finden',
                                        $elm$core$Maybe$Just('plan')) : (A2($elm$core$String$startsWith, 'map', fragment) ? _Utils_Tuple2(
                                        'Neue Route',
                                        $elm$core$Maybe$Just('plan')) : _Utils_Tuple2(
                                        'Zur Karte',
                                        $elm$core$Maybe$Just('map')));
                                    var btnText = _v0.a;
                                    var targetFrag = _v0.b;
                                    return A2(
                                        $elm$html$Html$button,
                                        _List_fromArray(
                                            [
                                                $elm$html$Html$Attributes$class('button is-rounded header-action-button has-text-weight-medium px-5'),
                                                $elm$html$Html$Events$onClick(
                                                    $author$project$Main$LinkClicked(
                                                        $elm$browser$Browser$Internal(
                                                            {
    ...
    var $author$project$Main$viewFloorButton = F2(
        function (etage, label) {
            return A2(
                $elm$html$Html$button,
                _List_fromArray(
                    [
                        $elm$html$Html$Attributes$class('etagen-btn'),
                        ...
                        $elm$html$Html$Events$onClick(
                            $author$project$Main$LinkClicked(
                                $elm$browser$Browser$External('javascript:window.wechsleEtage(\u0027' + (etage + '\u0027);'))))
                    ]),
                _List_fromArray(
                    [
                    ...
                    A2(
                        ...
                        _List_fromArray(
                            [
                                ...
                                A2($author$project$Main$viewFloorButton, '05', '5'),
                                A2($author$project$Main$viewFloorButton, '04', '4'),
                                A2($author$project$Main$viewFloorButton, '03', '3'),
                                A2($author$project$Main$viewFloorButton, '02', '2'),
                                A2($author$project$Main$viewFloorButton, '01', '1'),
                                A2($author$project$Main$viewFloorButton, '00', 'EG / 0'),
                                A2($author$project$Main$viewFloorButton, '-1', '-1')
                            ]))
                ]));
    };
    ...
    var $author$project$Main$viewStart = function (model) {
        return A2(
            ...
            _List_fromArray(
                [
                    $elm$html$Html$Attributes$class('is-flex-grow-1 is-flex is-flex-direction-column')
                ]),
            _List_fromArray(
                [
                    A2(
                                                                        ...
                                                                        _List_fromArray(
                                                                            [
                                                                                A2(
                                                                                    ...
                                                                                    _List_fromArray(
                                                                                        [
                                                                                            $elm$html$Html$Attributes$class('color-block is-flex-direction-column'),
                                                                        ...
                                                                        _List_fromArray(
                                                                            [
                                                                                A2(
                                                                                    ...
                                                                                    _List_fromArray(
                                                                                        [
                                                                                            $elm$html$Html$Attributes$class('color-block is-flex-direction-row'),
                                                                                            A2($elm$html$Html$Attributes$style, 'bottom', '40px'),
                                                                                            A2($elm$html$Html$Attributes$style, 'left', '40px')
                                                                                        ]),
                                                                                    _List_fromArray(
    ...
    var $author$project$Main$view = function (model) {
        var fragment = A2($elm$core$Maybe$withDefault, '', model.url.fragment);
        return {
            body: A2($elm$core$String$startsWith, 'map', fragment) ? _List_fromArray(
                [
                    $author$project$Main$viewMapOverlay(model)
                ]) : (A2($elm$core$String$startsWith, 'plan', fragment) ? _List_fromArray(
                [
                    A2(
                        $elm$html$Html$div,
                        _List_fromArray(
                            [
                                A2($elm$html$Html$Attributes$style, 'background-color', 'var(--bulma-scheme-main, #ffffff)'),
                        ...
                        _List_fromArray(
                            [
                                ...
                                A2(
                                    ...
                                    _List_fromArray(
                                        [
                                            $elm$html$Html$Attributes$class('is-flex-grow-1 is-flex is-align-items-center is-justify-content-center px-4'),
                                            $elm$html$Html$Events$onClick($author$project$Main$CloseDropdowns)
                                        ]),
                                    _List_fromArray(
                                        [
                                            A2(
                                                ...
                                                _List_fromArray(
                                                    [
                                                        $elm$html$Html$Attributes$class('has-text-centered w-100')
                                                    ]),
                                                _List_fromArray(
                                                    [
                                                        A2(
                                                            ...
                                                            _List_fromArray(
                                                                [
                                                                    $elm$html$Html$Attributes$class('title is-size-2-desktop is-size-3-mobile has-text-weight-bold mb-6'),
