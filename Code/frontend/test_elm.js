...
//
    ...
    var $author$project$TestDecode$sendResult = _Platform_outgoingPort('sendResult', $elm$json$Json$Encode$string);
    ...
    var $author$project$TestDecode$testDecode = function (jsonString) {
    ...
    var $author$project$TestDecode$main = $elm$core$Platform$worker(
        {
            init: function (flags) {
                return _Utils_Tuple2(
                    _Utils_Tuple0,
                    $author$project$TestDecode$sendResult(
                        $author$project$TestDecode$testDecode(flags)));
            },
    ...
    _Platform_export({'TestDecode': {'init': $author$project$TestDecode$main($elm$json$Json$Decode$string)(0)}});
}(this));