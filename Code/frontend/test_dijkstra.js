...
//
    ...
    var $author$project$TestDijkstra$sendResult = _Platform_outgoingPort('sendResult', $elm$json$Json$Encode$string);
    ...
    var $author$project$TestDijkstra$testDijkstra = function (jsonString) {
        var _v0 = A2($elm$json$Json$Decode$decodeString, $author$project$GraphData$decodeGraphData, jsonString);
        if (_v0.$ === 'Ok') {
            var data = _v0.a;
            var _v1 = A3($author$project$Dijkstra$shortestPath, '7723_00_039__1', '7723_00_038__2', data.graph);
            if (_v1.$ === 'Just') {
                var path = _v1.a;
                return 'PATH: ' + A2($elm$core$String$join, ' -> ', path);
            } else {
    ...
    var $author$project$TestDijkstra$main = $elm$core$Platform$worker(
        {
            init: function (flags) {
                return _Utils_Tuple2(
                    _Utils_Tuple0,
                    $author$project$TestDijkstra$sendResult(
                        $author$project$TestDijkstra$testDijkstra(flags)));
            },
    ...
    _Platform_export({'TestDijkstra': {'init': $author$project$TestDijkstra$main($elm$json$Json$Decode$string)(0)}});
}(this));